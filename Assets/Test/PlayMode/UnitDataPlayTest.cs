...
public class UnitDataPlayTest : PlayTest
{
    ...
    public IEnumerator UnitData_SettingUnits()
    {
        ...
        Assert.That(FieldManager.IsHasTeamUnitActorCount(TYPE_BATTLE_TEAM.Left) == 35, Is.True);
        Assert.That(FieldManager.IsHasTeamUnitActorCount(TYPE_BATTLE_TEAM.Right) == 35, Is.True);
        yield return null;
    }
